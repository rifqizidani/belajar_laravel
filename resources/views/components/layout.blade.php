    ...
    <div class="flex flex-1 items-center justify-end md:justify-between">
      <nav aria-label="Global" class="hidden md:block">
        <ul class="flex items-center gap-6 text-sm">
          ...
          <li>
            <x-nav-link class="text-gray-500 transition hover:text-gray-500/75" href="/pendaftaran" :active="request()->is('pendaftaran')">Pendaftaran</x-nav-link>
          </li>

          <li>
            <x-nav-link class="text-gray-500 transition hover:text-gray-500/75" href="/pengumuman" :active="request()->is('pengumuman')">Pengumuman</x-nav-link>
          </li>
        </ul>
      </nav>
